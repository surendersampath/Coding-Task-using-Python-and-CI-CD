...
class MyModuleTestCase(unittest.TestCase):
    ...
    def testcase_seatnumber_1(self):
        result = get_seat_number_from_boarding_pass("BFFFBBFRRR")
        self.assertEqual(result, 567)

    def testcase_seatnumber_2(self):
        result = get_seat_number_from_boarding_pass("FFFBBBFRRR")
        self.assertEqual(result, 119)

    def testcase_seatnumber_3(self):
        result = get_seat_number_from_boarding_pass("BBFFBBFRLL")
        self.assertEqual(result, 820)

    def testcase_seatnumber_4(self):
        result = get_seat_number_from_boarding_pass("FBFBBFFRLR")
